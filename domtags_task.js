...
p0.innerHTML=`this is firstname:- ${f}`
fi.value=''

let p1=document.createElement("p")
console.log("SecondName:-"+s)
document.body.appendChild(p1)
p1.innerHTML=`this is secondname:- ${s}`
sc.value=''

let p2=document.createElement("p")
console.log("email:-"+e)
document.body.appendChild(p2)
p2.innerHTML=`this is E-mail:- ${e}`
em.value=''

let p3=document.createElement("p")
console.log("Phoneno:-"+ph)
document.body.appendChild(p3)
p3.innerHTML=`this is phoneno:- ${ph}`
pho.value=''

let p4=document.createElement("p")
console.log("City:-"+c)
document.body.appendChild(p4)
p4.innerHTML=`this is city:- ${c}`
ci.value=''
}
